...
parser.add_argument('--save_path', default='./Projects/slice_ar/results/nhg/oo/', type= str, help='results save path')
parser.add_argument('--anno_t', default='./Projects/slice_ar/csv/nhg/oo_train.csv', type=str, help='train annotation path')
parser.add_argument('--anno_v', default='./Projects/slice_ar/csv/nhg/oo_val.csv', type=str, help='val annotation path')
#parser.add_argument('--image', default='', type=str, help='Video to images save path')
...
class Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return imgs, labels_phase, img_names.split('/')[-1]
    def __len__(self):
...
def get_data():
    ...
    train_dataset = Dataset(train_paths, train_labels, train_transforms)
    val_dataset = Dataset(val_paths, val_labels, test_transforms)
...
def train_model(train_dataset, val_dataset):
    ...
    for epoch in range(epochs):
        ...
        for data in train_loader:
            num = num + 1
            inputs, labels_phase, img_names = data
            if use_gpu:
