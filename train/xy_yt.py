...
parser.add_argument('--save_path', default='./Projects/slice_ar/results/nhg/xyxt/', type= str, help='results save path')
parser.add_argument('--anno_t', default='./Projects/slice_ar/csv/nhg/xyxt_train.csv', type=str, help='train annotation path')
parser.add_argument('--anno_v', default='./Projects/slice_ar/csv/nhg/xyxt_val.csv', type=str, help='val annotation path')
...
def get_data():
    ...
    train_dataset = Dataset(train_paths, train_paths2, train_labels, train_transforms)
    val_dataset = Dataset(val_paths, val_paths2, val_labels, test_transforms)
