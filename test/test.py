...
parser.add_argument('--anno_t', default='./Projects/slice_ar/csv/nhg/oo_test.csv', type=str, help='videos path')
parser.add_argument('--save_path', default='./Projects/slice_ar/results/nhg/oo/', type=str, help='results path')
parser.add_argument('--test_path', default='./Projects/slice_ar/results/nhg/oo/best.pth', type=str, help='test path')
...
class Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #print('labels_phase', labels_phase)
        imgs = self.loader(img_names)
        if self.transform is not None:
            imgs = self.transform(imgs)
        return imgs, labels_phase, img_names.split('/')[-1]#, data''''''
    def __len__(self):
...
def get_data():
    ...
    test_dataset = Dataset(test_paths, test_labels, test_transforms)
