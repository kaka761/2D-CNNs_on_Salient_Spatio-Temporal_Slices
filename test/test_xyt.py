...
parser.add_argument('--anno_t', default='./Projects/slice_ar/csv/cam/xyt_test.csv', type=str, help='videos path')
parser.add_argument('--save_path', default='./Projects/slice_ar/results/cam/xyt/', type=str, help='results path')
parser.add_argument('--test_path', default='./Projects/slice_ar/results/cam/xyt/best.pth', type=str, help='test path')
...
class Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return imgs, imgs2, imgs3, labels_phase, img_names.split('/')[-1]#, data''''''
    def __len__(self):
...
def get_data():
    ...
    test_dataset = Dataset(test_paths, test_paths2, test_paths3, test_labels, test_transforms)
